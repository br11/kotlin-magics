...
import com.github.br11.api.proxy.Proxy
import com.github.br11.api.proxy.convert
...
fun main(args: Array<String>) {
    val service = CorporateCustomerService()
    val request = CorporateCustomer("askjasiupijqljwelkjqwe")

    val response = service.saveApproved(request)
